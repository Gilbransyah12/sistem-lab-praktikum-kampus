...
<div class="page-header">
    <div class="header-content">
        <div class="header-info">
            ...
            <p class="header-subtitle">Kelola absensi mahasiswa untuk setiap kelas praktikum</p>
        </div>
    </div>
</div>
...
<div class="card-filter" style="margin-bottom: 1.5rem; background: white; padding: 1.5rem; border-radius: 16px; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.05);">
    <form action="{{ route('instruktur.absensi.index') }}" method="GET" class="filter-form">
        ...
        <div class="filter-reset" style="margin-top: 1rem; display: flex; justify-content: flex-end;">
            <a href="{{ route('instruktur.absensi.index') }}" class="btn btn-sm btn-secondary" style="background: #f1f5f9; color: #64748b; padding: 0.5rem 1rem; border-radius: 8px; text-decoration: none; font-size: 0.8125rem; font-weight: 600;">
        ...
        <div class="card-content">
            ...
            <div class="card-stats">
                <div class="stat-item">
                    ...
                    <span>{{ $j->sesi->count() ?? 0 }} Sesi</span>
                </div>
            </div>
        </div>
        <div class="card-action">
            <a href="{{ route('instruktur.absensi.sesi', $j) }}" class="btn btn-primary">
