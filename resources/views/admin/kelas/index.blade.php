...
<div class="card">
    ...
    <div class="card-filter">
        <form action="{{ route('admin.kelas.index') }}" method="GET" class="filter-form">
            <div class="filter-grid">
                <div class="filter-group search-group">
                    <label for="search"><i class="fas fa-search"></i> Cari Kelas</label>
                    <div class="search-input-wrapper">
                        <input type="text" name="search" id="search" class="filter-input" 
                               placeholder="Cari Nama atau Kode Kelas..." value="{{ request('search') }}">
            ...
            <table class="premium-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="kelas-code-badge">{{ $k->kode_kelas }}</span>
                        </td>
                        <td>
                            <span class="kelas-name">{{ $k->nama_kelas }}</span>
                        </td>
                        <td class="text-center">
                            <div class="action-cell justify-content-center">
                                <a href="{{ route('admin.kelas.edit', $k) }}" class="btn-action edit" title="Edit">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <form action="{{ route('admin.kelas.destroy', $k) }}" method="POST" 
                                      onsubmit="return confirm('Yakin hapus kelas ini?')" style="display:inline;">
                                    @csrf
                                    @method('DELETE')
